    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-50 flex flex-col">
      ...
      {localDemoOpen && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/60 px-3 sm:px-4">
          <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-cyan-500/40 bg-slate-950/95 p-4 sm:p-6 shadow-[0_0_40px_rgba(34,211,238,0.9)]">
            <h2 className="text-lg sm:text-xl font-semibold text-cyan-300 mb-2 sm:mb-3">Demande de démo GitPusher™ PRO</h2>
            ...
            <DemoRequestForm onClose={() => setLocalDemoOpen(false)} />
          </div>
        </div>
      )}
